                    ...
                    <ul className="flex gap-6 items-center">
                        {
                            menus.map((item, index)=>(
                                <li key={index}>
                                    <Link 
                                        to={item.href}
                                        className="block py-8 text-center bg-gradient-to-r hover:from-pink-500 hover:to-orange-500 w-[100px] hover:text-white"
                                    >{item.label}</Link>
                                </li>
                            ))
                        }
                        ...
                        <Link 
                            className="bg-gradient-to-r from-teal-400 to-blue-500 hover:from-pink-500 hover:to-orange-500 py-3 px-10 text-md font-semibold text-white block text-center hover:bg-rose-600 hover:text-white"
                            to="/signup"
                        >Signup</Link>
                    </ul>
                </div>
                ...
                <div className="w-10/12 mx-auto grid grid-cols-4">
                    ...
                    <div>
                        ...
                        <form className="space-y-4">
                            ...
                            <button className="bg-gradient-to-r from-teal-400 to-blue-500 hover:from-pink-500 hover:to-orange-500 text-white py-3 px-6 rounded">Submit</button>
                        </form>
                    </div>
                </div>
            </footer>
